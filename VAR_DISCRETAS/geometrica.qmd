...
# a) Probabilidad de exactamente 5 lanzamientos
prob_5 <- (1-p)^(5-1) * p
cat("a) Probabilidad de necesitar exactamente 5 lanzamientos:", round(prob_5,6), "\n")

# b) Probabilidad de necesitar más de 3 lanzamientos
prob_mas_3 <- (1-p)^3
cat("b) Probabilidad de necesitar más de 3 lanzamientos:", round(prob_mas_3,6), "\n")
...
prob_3 <- (1-p)^(3-1) * p
cat("a) Probabilidad de anotar por primera vez en el tercer intento:", round(prob_3,6), "\n")

# b) Número esperado de intentos
media <- 1/p
cat("b) Número esperado de intentos:", round(media,4), "\n")

# c) Probabilidad de necesitar entre 2 y 5 intentos
prob_2_5 <- sum((1-p)^(1:4) * p)
cat("c) Probabilidad de necesitar entre 2 y 5 intentos:", round(prob_2_5,6), "\n")
...
esperado <- 1/p
cat("a) Número esperado de inspecciones:", esperado, "\n")

# b) Probabilidad de que la primera defectuosa aparezca después de la pieza 100
prob_mas_100 <- (1-p)^100
cat("b) Probabilidad de que la primera defectuosa aparezca después de la pieza 100:", round(prob_mas_100,6), "\n")

# c) Verificar propiedad de falta de memoria
P_condicional <- (1-p)^(150)/ (1-p)^50
P_n <- (1-p)^100
cat("c) Verificación falta de memoria: P(X>150 | X>50) =", round(P_condicional,6), "\n")
cat("   P(X>100) =", round(P_n,6), "\n")
