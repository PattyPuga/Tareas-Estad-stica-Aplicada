...
#municipios_jalisco <- st_read("data/10mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)
...
mapa_municipios <- ggplot(municipios_durango) +
  geom_sf(fill = "lightpink", color = "white", size = 0.3) +
  labs(
...
#datos_total <- read_csv("1_estadistica_descriptiva/data/cpv_valor_10.csv", na = c("ND"))
...
datos <- st_join(municipios_durango, datos)
...
ggplot(datos) +
  ...
  labs(
    title = "Edad (mediana) de los Municipios de Durango",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(sample = edad_mediana)) +
    ...
    subtitle = "Edad Mediana - Población Durango") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Derechohabientes IMSS (%) de los Municipios de Durango",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(sample = porcentaje_de_la_poblacion_derechohabiente_en_el_imss)) +
    ...
    labs(title = "Gráfico Q-Q para Normalidad",
    subtitle = "Derechohabientes IMSS (%) - Durango") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Población de los Municipios de Durango",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
